...
exports.retryUntilTruthy = exports.retryUntilReturn = exports.executeSafelyAsync = undefined;

var executeSafelyAsync = exports.executeSafelyAsync = function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(context, func) {
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 5:
            ...
            createFailAlert(context, 'Error', _context.t0);
  ...
  return function executeSafelyAsync(_x, _x2) {
 ...
 */
var retryUntilReturn = exports.retryUntilReturn = function () {
  var _ref2 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2(fn, maxRetries, delay) {
  ...
  return function retryUntilReturn(_x3, _x4, _x5) {
...
var retryUntilTruthy = exports.retryUntilTruthy = function () {
  var _ref3 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee3(fn, maxRetries, delay) {
    var result;
  ...
  return function retryUntilTruthy(_x6, _x7, _x8) {
...
exports.userDownloadsDirectory = userDownloadsDirectory;
exports.fileAttributes = fileAttributes;
exports.withErrorPointer = withErrorPointer;
exports.sleep = sleep;
exports.resourcesPath = resourcesPath;
exports.scriptsPath = scriptsPath;
exports.readFileAsJson = readFileAsJson;
exports.localPathToNSURLString = localPathToNSURLString;
exports.documentFromContext = documentFromContext;
exports.pluralize = pluralize;

var _logger = __webpack_require__(66);

var _sketchModuleFs = __webpack_require__(343);
...
function createFailAlert(context, title, e) {
  (0, _logger.trace)(e);
...
function userDownloadsDirectory() {
  var dirs = fileManager().URLsForDirectory_inDomains_(NSDownloadsDirectory, NSUserDomainMask);
  if (dirs.length) {
    return dirs[0].path();
  } else {
...
function fileAttributes(path) {
  return withErrorPointer(function (errorPtr) {
...
function withErrorPointer(fn) {
  var errorPtr = MOPointer.alloc().init();
  var result = fn(errorPtr);
  var error = errorPtr.value();
  if (error) {
    (0, _logger.trace)(error);
...
function basePath() {
  return COScript.currentCOScript().env().scriptURL.path().stringByDeletingLastPathComponent().stringByDeletingLastPathComponent();
}

function readFileAsJson(path) {
  return JSON.parse((0, _sketchModuleFs.readFile)(path, NSUTF8StringEncoding) + '');
}

function localPathToNSURLString(localPath) {
...
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(128)["setTimeout"]))
...
exports.warn = warn;
exports.isWarnEnabled = isWarnEnabled;
exports.error = error;
exports.isErrorEnabled = isErrorEnabled;
...
function isTraceEnabled() {
  return _config.logLevel <= _config.logLevels.TRACE;
}
...
function isDebugEnabled() {
  return _config.logLevel <= _config.logLevels.DEBUG;
}
...
function isInfoEnabled() {
  return _config.logLevel <= _config.logLevels.INFO;
}
...
function isWarnEnabled() {
  return _config.logLevel <= _config.logLevels.WARN;
}
...
function isErrorEnabled() {
  return _config.logLevel <= _config.logLevels.ERROR;
}
...
/* WEBPACK VAR INJECTION */(function(setTimeout) {var ctx = __webpack_require__(19);
...
exports.getSelectedIssueKey = getSelectedIssueKey;
exports.setSelectedIssueKey = setSelectedIssueKey;
exports.triggerExportSelectedLayers = triggerExportSelectedLayers;
exports.setExportSelectedLayersFn = setExportSelectedLayersFn;
var keys = {
  selectedIssueKey: 'selectedIssueKey',
  exportSelectedLayersFn: 'exportSelectedLayersFn'
};

var dictionaryKey = 'atlassian-sketch-plugin-state';

var pluginState = function () {
  var _state = NSThread.mainThread().threadDictionary()[dictionaryKey];
  if (!_state) {
...
function getSelectedIssueKey() {
  var issueKey = pluginState[keys.selectedIssueKey];
  return issueKey ? issueKey + '' : null; // convert to JS string
}

function setSelectedIssueKey(key) {
  pluginState[keys.selectedIssueKey] = key;
}

function triggerExportSelectedLayers() {
  var fn = pluginState[keys.exportSelectedLayersFn];
  if (fn) {
    fn();
    return true;
  } else {
...
function setExportSelectedLayersFn(fn) {
  ...
  coscript.scheduleWithInterval_jsFunction(
    ...
    function () {
      ...
      if (ids.every(function (_id) { return !_id })) { // if everything is cleared
        /* REMOVED coscript shouldKeepAround false */
      }
    }
  )
  return id
  ...
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(context) {
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            withExportButtonBar(context, function (exportButtonBar) {
              var exportButtons = exportButtonBar.subviews();

              // Assumption: There are two standard export buttons (plus ours)
              if (exportButtons.length == 3) {
                var _jiraButton = exportButtons[2];
                var toolTip = _jiraButton.toolTip && _jiraButton.toolTip();
                if (toolTip && toolTip == jiraButtonToolTip) {
                  // button already registered \o/
                } else {
                  (0, _logger.error)('Found three export buttons, but the \'Export to JIRA\' button isn\'t there');
                }
                return;
              }
              ...
              var exportButton = exportButtons[0];
              var title = exportButton.title && exportButton.title();
              if (!title || title.indexOf('Export ') != 0) {
                (0, _logger.trace)('Possible export button has title: ' + title);
                return;
              }

              // Add the JIRA button
              var uploadIcon = NSImage.alloc().initWithContentsOfFile(context.plugin.urlForResourceNamed('upload-icon.png').path());
              var jiraButtonDelegate = (0, _buttonDelegate2.default)({
                onClick: function onClick() {
                  if (!(0, _pluginState.triggerExportSelectedLayers)()) {
                    (0, _logger.error)('Failed to trigger export of selected layers');
                  }
                }
              });
              var jiraButton = NSButton.buttonWithImage_target_action(uploadIcon, jiraButtonDelegate, _buttonDelegate.onClickSelector);
              ...
              var eFrame = exportButton.frame();
              exportButton.setFrame(NSMakeRect(eFrame.origin.x, eFrame.origin.y, eFrame.size.width - exportButtonOffset, eFrame.size.height));
            });
        ...
        switch (_context2.prev = _context2.next) {
          case 0:
            withExportButtonBar(context, function (exportButtonBar) {
              ...
              var jiraButton = exportButtons[2];
              var toolTip = jiraButton.toolTip && jiraButton.toolTip();
              if (toolTip != jiraButtonToolTip) {
                (0, _logger.error)('\'' + jiraButtonToolTip + '\' button wasn\'t where it should be');
                return;
              }
...
var _buttonDelegate = __webpack_require__(134);

var _buttonDelegate2 = _interopRequireDefault(_buttonDelegate);

var _pluginState = __webpack_require__(93);
...
var jiraButtonToolTip = 'Export to JIRA';
var exportButtonOffset = 44;

function withExportButtonBar(context, callback) {
  var document = (0, _util.documentFromContext)(context);
  if (!document) {
    return;
  }
  var contentView = document.documentWindow().contentView();
  if (!contentView) {
    return;
  }

  // Assumption: the NSView subclass for exports is named 'MSExportStackView'
  var exportStackView = findSubviewWithClass(contentView, 'MSExportStackView');
  if (!exportStackView) {
    (0, _logger.trace)('Couldn\'t find MSExportStackView');
    return;
  }

  // Assumption: No subviews for 'MSExportStackView' the selection can't be exported (?)
  var exportSubviews = exportStackView.subviews();
  if (exportSubviews.length == 0) {
    (0, _logger.trace)('MSExportStackView has no subviews');
    return;
  }
...
function findSubviewWithClass(view, clazz) {
  ...
  if (view.subviews) {
    ...
    for (var i = subviews.length - 1; i >= 0; i--) {
      var result = findSubviewWithClass(subviews[i], clazz);
      if (result) {
        return result;
      }
    }
...
var _exportButton = __webpack_require__(130);
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            (0, _util.executeSafelyAsync)(context, function () {
              if ((0, _pluginState.getSelectedIssueKey)()) {
                _exportButton2.default.add(context);
              } else {
                _exportButton2.default.remove(context);
              }
            });
...
exports.maxMentionPickerResults = exports.jiraDateMomentFormat = exports.cocoaDelegatePollInterval = exports.feedbackUrl = exports.jiraAuthorizationUrlRetryInterval = exports.jiraAuthorizationUrlMaxRetries = exports.userAuthorizationPollInterval = exports.thumbnailRetryDelay = exports.thumbnailRetryMax = exports.attachmentUploadConcurrency = exports.thumbnailDownloadConcurrency = exports.bearerTokenRefreshInterval = exports.bearerTokenExpirySafetyMargin = exports.analyticsIdKey = exports.analyticsApiMultipleEvents = exports.analyticsApiSingleEvent = exports.analyticsApiBaseUrl = exports.standardIssueFields = exports.jiraSketchIntegrationFaqUrl = exports.jiraSketchIntegrationApi = exports.jiraSketchIntegrationApiBaseUrl = exports.jiraSketchIntegrationBaseUrl = exports.pluginVersion = exports.tempDirName = exports.pluginName = exports.logLevel = exports.logLevels = undefined;
...
var configFile = (0, _util.readFileAsJson)((0, _util.resourcesPath)() + '/config.json');
var config = (0, _lodash.assign)({}, defaults, configFile);

console.log(JSON.stringify(config));

var manifest = (0, _util.readFileAsJson)((0, _util.scriptsPath)() + '/manifest.json');
...
var logLevel = exports.logLevel = parseLogLevel(config.logLevel);

var pluginName = exports.pluginName = 'jira-sketch-plugin';
var tempDirName = exports.tempDirName = pluginName;

var pluginVersion = exports.pluginVersion = manifest.version;

var jiraSketchIntegrationBaseUrl = exports.jiraSketchIntegrationBaseUrl = config.jiraSketchIntegrationBaseUrl;

var jiraSketchIntegrationApiBaseUrl = exports.jiraSketchIntegrationApiBaseUrl = jiraSketchIntegrationBaseUrl + '/api';

var jiraSketchIntegrationApi = exports.jiraSketchIntegrationApi = {
...
var jiraSketchIntegrationFaqUrl = exports.jiraSketchIntegrationFaqUrl = jiraSketchIntegrationBaseUrl + '/faq';

var standardIssueFields = exports.standardIssueFields = ['issuetype', 'summary', 'status', 'attachment', 'assignee', 'reporter'];

var analyticsApiBaseUrl = exports.analyticsApiBaseUrl = config.analyticsApiBaseUrl;
var analyticsApiSingleEvent = exports.analyticsApiSingleEvent = analyticsApiBaseUrl + '/event';
var analyticsApiMultipleEvents = exports.analyticsApiMultipleEvents = analyticsApiBaseUrl + '/events';
var analyticsIdKey = exports.analyticsIdKey = 'atlassian.analytics.id';

var bearerTokenExpirySafetyMargin = exports.bearerTokenExpirySafetyMargin = config.bearerTokenExpirySafetyMargin;
var bearerTokenRefreshInterval = exports.bearerTokenRefreshInterval = config.bearerTokenRefreshInterval;

var thumbnailDownloadConcurrency = exports.thumbnailDownloadConcurrency = config.thumbnailDownloadConcurrency;
var attachmentUploadConcurrency = exports.attachmentUploadConcurrency = config.attachmentUploadConcurrency;

var thumbnailRetryMax = exports.thumbnailRetryMax = config.thumbnailRetryMax;
var thumbnailRetryDelay = exports.thumbnailRetryDelay = config.thumbnailRetryDelay;

var userAuthorizationPollInterval = exports.userAuthorizationPollInterval = config.userAuthorizationPollInterval;

var jiraAuthorizationUrlMaxRetries = exports.jiraAuthorizationUrlMaxRetries = config.jiraAuthorizationUrlMaxRetries;
var jiraAuthorizationUrlRetryInterval = exports.jiraAuthorizationUrlRetryInterval = config.jiraAuthorizationUrlRetryInterval;

var feedbackUrl = exports.feedbackUrl = 'https://goo.gl/forms/OrIB4RoEePhL3lkv2';

var cocoaDelegatePollInterval = exports.cocoaDelegatePollInterval = config.cocoaDelegatePollInterval;

var jiraDateMomentFormat = exports.jiraDateMomentFormat = 'YYYY-MM-DDTHH:mm:ss.SSSZZ';

var maxMentionPickerResults = exports.maxMentionPickerResults = config.maxMentionPickerResults;

function parseLogLevel(level) {
  if ((0, _lodash.isNumber)(level)) {
    return level;
  }
  var levelName = level.trim().toUpperCase();
...
if (mocha.valueForKey(frameworkName)) {
  (0, _logger.trace)(frameworkName + ' already loaded.');
} else if (mocha.loadFrameworkWithName_inDirectory(frameworkName, (0, _util.resourcesPath)())) {
  (0, _logger.trace)(frameworkName + ' loaded!');
  mocha.setValue_forKey_(true, frameworkName);
} else {
  (0, _logger.trace)(frameworkName + ' failed to load!');
}
...
exports.onClickSelector = undefined;
...
var _cocoascriptClass = __webpack_require__(137);

var _cocoascriptClass2 = _interopRequireDefault(_cocoascriptClass);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

var onClickSelector = exports.onClickSelector = NSSelectorFromString('onClick:');

var DelegateClass = (0, _cocoascriptClass2.default)({
  classname: 'AtlassianNSButtonDelegate',
  callbacks: null,
  'onClick:': function onClick(sender) {
...
var _runtime = __webpack_require__(138);
...
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(49), __webpack_require__(344)(module)))
